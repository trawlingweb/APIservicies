...
| time_distance          | Hours elapsed between the publication date and the indexing date                                                                                            |    No    |    No    |  Fload  |                               |
...
| hash                    | Identification code based on the text                                                                                                                          |    No    |    No     | String  |                             |
| published               | Date the post was published                                                                                                                                    |    No    |    No     |  Date   |        ISO 8601-UTC         |
| crawled                 | Indexing date                                                                                                                                                   |    No    |    Si     | Integer | UNIX Timestamp milisegundos |
