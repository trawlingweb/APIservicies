...
Este método, permite obtener resultados procesados de cada Worker configurado en Twitter. Se pueden utilizar delimitadores temporales para acotar el contenido devuelto.
...
| crawled                 | Fecha de indexación (Ver sección mejores prácticas, Uso de las Fechas published y Crawled)                                                                                                                                                                  |    No    |    Sí     | Entero  | UNIX Timestamp milisegundos |
...
| time_distance           | Horas transcurridas entre la fecha de publicación y la de indexación                                                                                                                 |    No    |    No     | Decimal |                             |
