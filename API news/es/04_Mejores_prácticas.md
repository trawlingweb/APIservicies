...
Explicación: 
- **Organizazación**: Las noticias se organizan por fecha de captura ***(sort=crawled)***
...
Explicación: 
- **Organizazación**: Las noticias se organizan por fecha de publicación ***(sort=published)***
...
- **Published**: Agrupa por fecha de publicación. La fecha que se usará en la llamada al API es la fecha en la que se publicó la noticia o el post y fue definida por quien la publicó originalmente. `sortr=published`
