...
```
https://tiktok.trawlingweb.com/workers/?token={APIKEY}
```
...
One time it is launched petition to API TikTok, this will return a structured response data:
...
| type        | Type of Worker (facebook, tiktok, twitter)          |    No    |    No    | String  |              |
